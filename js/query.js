$(function(){
  ...
  $('#lavel1').click(
  function(){
      $('h3').html('<img src="img/curry_ko.png" class="img_first"></img>');
  ...
  $('#lavel2').click(
    function(){
      $('h3').html('<img src="img/cooking_hoajyao.png" class="img_first"></img>');
    ...
    $('#lavel3').click(
      function(){
      $('h3').html('<img src="img/cooking_spice_pepper_tsubu.png" class="img_first"></img>');
