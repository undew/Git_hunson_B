...
var ht3m =  $('#ht3m').val();
    ...
    $('.first_message').html(m3m);
      ...
      function(){
        ...
        $('.second_message').css('transition','0.3s');
          $('.second_h3').html('<img src="img/味_カスリメティ.jpg" class="img_second"></img>');
      ...
      $('#lavel5').click(
        function(){
          $('.second_board').css('opacity','1');
          $('.second_message').css('opacity','1');
          $('.second_h3').html('<img src="img/味_シナモン.jpg" class="img_second"></img>');
        ...
        $('#lavel6').click(
          function(){
            $('.second_board').css('opacity','1');
            $('.second_message').css('opacity','1');
          $('.second_h3').html('<img src="img/味_花椒.jpg" class="img_second"></img>');
  ...
  // -------------------------third------------------------------------
          ...
          $('.third_h3').html('<img src="img/香_ガラムマサラ.jpg  " class="img_third"></img>');
          ...
          function(){
            $('.third_board').css('opacity','1');
            $('.third_message').css('opacity','1');
            $('.third_h3').html('<img src="img/香_クミンシード.jpg" class="img_third"></img>');
        ...
        $('#lavel9').click(
          function(){
            $('.third_board').css('opacity','1');
            $('.third_message').css('opacity','1');
            $('.third_h3').html('<img src="img/香_グリーンカルダモン.jpg" class="img_third"></img>');
  ...
  // -------------------------four------------------------------------
        ...
        function(){
          ...
          $('.four_h3').html('<img src="img/辛_チリペッパー.jpg" class="img_four"></img>');
         ...
         $('#lavel11').click(
           ...
           $('.four_board').css('opacity','1');
           $('.four_message').css('opacity','1');
          $('.four_h3').html('<img src="img/辛_ブラウンマスタード.jpg" class="img_four"></img>');
        ...
        $('.four_board').css('opacity','1');
        $('.four_message').css('opacity','1');
        $('.four_h3').html('<img src="img/辛_ブラックペッパー.jpg" class="img_four"></img>');
